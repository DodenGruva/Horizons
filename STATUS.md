...
1. Soak asynchronous mip propagation through long exploration, restart, shutdown, and
...
- `dev/DocCheck.ps1` passes 234 checks under both Windows PowerShell 5.1 and PowerShell 7.
